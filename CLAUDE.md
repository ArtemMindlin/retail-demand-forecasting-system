...
- `src/retail_forecasting/models/`: forecast models only (`naive.py`, `boosting.py` for LightGBM — the current champion — and `catboosting.py` for CatBoost).
