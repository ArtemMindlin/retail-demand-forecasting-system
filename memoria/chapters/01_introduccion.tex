...
alternativas se acompaña de un intervalo de confianza obtenido por remuestreo.

Ese criterio explica también cómo se resolvió la elección del modelo final, que no fue por error
estadístico ni tampoco, en última instancia, por coste. El coste logístico de las alternativas
resulta indistinguible entre sí una vez se le pone intervalo, de modo que no ordena a los
candidatos; lo que los separa es el nivel de servicio que su política de pedido alcanza a ese
mismo coste. El modelo probabilístico se prefiere por esa segunda magnitud, y el
Capítulo~\ref{chap:resultados} documenta ambas lecturas junto con el hecho de que no coinciden.
