...
8  & Trabajo decente y crecimiento económico & La reducción del coste logístico (9,5\% demostrado empíricamente) contribuye a la eficiencia económica del sector distribución, sector con alta empleabilidad. & Medio \\
9  & Industria, innovación e infraestructura & El sistema implementa un pipeline MLOps de nivel industrial con técnicas de vanguardia (Conformal Prediction, optimización multi-objetivo) aplicadas a un problema real de distribución. & Medio \\
