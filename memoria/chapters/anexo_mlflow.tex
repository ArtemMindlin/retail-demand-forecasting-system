...
\begin{figure}[H]
    ...
    \caption{Inventario del experimento \texttt{retail\_forecasting\_runs}, con 27 corridas
...
\begin{figure}[H]
    ...
    \caption{Ficha de la corrida \texttt{tfg\_latent\_20260831\_113339}, la rama de demanda
...
\begin{figure}[H]
    ...
    \caption{Artefactos de esa misma corrida, con \texttt{predictions.csv} abierto en el panel de
...
\begin{figure}[H]
    ...
    \caption{Métricas registradas por la búsqueda de hiperparámetros
