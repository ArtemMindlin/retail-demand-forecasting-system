...
Este apéndice recoge capturas de las siete vistas del cuadro de mandos, organizadas por los dos planos funcionales de la interfaz: el \textbf{plano de Operación} y el \textbf{plano de Análisis}. Las capturas se han tomado sobre una instancia local ejecutando los mismos artefactos que la instancia desplegada en \url{https://artemmindlin.site}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{figures/dashboard/ui_demanda_latente.png}
...
\begin{figure}[H]
    ...
    \caption{Vista \textit{Pareto Tuning} del plano de Análisis. Frente de Pareto multiobjeto (Pinball Loss vs. Winkler Score) generado por Optuna con muestreador TPE multiobjetivo, tabla comparativa de los modelos en la frontera y curva de sensibilidad al ratio de costes $c_s/c_h$.}
