...
\subsection{Dashboard Interactivo y de Gestión}

El endpoint raíz \texttt{GET /} sirve un dashboard React de página única (\textit{Single Page Application}) embebido en el propio servidor FastAPI. Esta aplicación web no es un simple visor estático, sino una herramienta de gestión y análisis logístico bidireccional que permite la interacción en tiempo real. 

Para ilustrar su funcionamiento, las Figuras~\ref{fig:dashboard_1} y \ref{fig:dashboard_2} recogen capturas de la interfaz desarrollada. El dashboard está organizado en cuatro paneles funcionales principales:
...
\begin{itemize}
    ...
    \item \textbf{Panel de Catálogo de SKUs}: Vista tabular de los SKUs más activos con su estado operacional codificado en color, la tendencia de demanda de los últimos 14 días y las métricas clave. Permite seleccionar un SKU para actualizar el panel de pronóstico.
    
    \item \textbf{Panel de Drift}: Gráfico con el PSI de cada feature de importancia, calculado por el módulo \texttt{drift/psi.py} y persistido como \texttt{drift\_report.json} al término de cada \texttt{experiment}. Se marca visualmente (en naranja para advertencias y rojo para alertas críticas) las features que han sufrido cambios distribucionales significativos desde el entrenamiento.
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/dashboard/dash1.png}
        \caption{Vista general de pronóstico y catálogo de SKUs.}
        \label{fig:dashboard_1}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/dashboard/dash2.png}
        \caption{Simulador What-If interactivo con recálculo en tiempo real.}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/dashboard/dash3.png}
        \caption{Monitor de Drift (Population Stability Index).}
        \label{fig:dashboard_3}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/dashboard/dash4.png}
        \caption{Panel de alertas y diagnóstico Post-Mortem.}
