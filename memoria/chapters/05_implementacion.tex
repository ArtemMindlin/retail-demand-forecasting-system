...
\shorthandon{>}%
\caption{Arquitectura del sistema: flujo de datos y decisiones entre las cuatro capas funcionales (Datos, Features, Modelado y Decisión) y la capa de entrega que las cierra. Los dos bloques discontinuos son transversales: el almacén de MLflow, que persiste cada ejecución para trazabilidad, y el lazo de monitorización, que vigila la distribución de entrada antes de decidir y el error una vez revelado (Sección~\ref{sec:monitorizacion}).}
