...
\begin{table}[htbp]
    ...
    \begin{tabular}{lll}
        ...
        Optimización multi-objetivo & Optuna (TPE, Pinball vs.\ Winkler) & Hyperopt, GridSearch \\
        Búsquedas dedicadas de un objetivo & Optuna (\textit{sampler} gaussiano) & TPE, medido en el Anexo~\ref{anx:tuning_imputador} \\
        Trazabilidad de experimentos & MLflow (almacén de corridas) & Weights \& Biases, artefactos en disco \\
