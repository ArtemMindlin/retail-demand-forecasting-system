...
\begin{enumerate}
    ...
    \item \textbf{Separación del azar}: El \textit{challenger} debe llegar marcado como concluyente en el \texttt{cost\_}\allowbreak\texttt{summary} de la ejecución, es decir, con el intervalo al 95\% de su hueco de coste frente al \textit{naive} estacional despejando el cero. El intervalo procede de un \textit{bootstrap} emparejado de $2.000$ remuestreos por conglomerados de serie, y exige un mínimo de ocho series para pronunciarse. A diferencia de los dos anteriores este guardarraíl no es configurable: un \texttt{cost\_summary} anterior a la introducción de la columna carece del campo, y en ese caso la puerta cede a los dos umbrales configurados en lugar de negarse a decidir.
\end{enumerate}
