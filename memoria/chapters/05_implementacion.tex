...
\begin{tikzpicture}[
  ...
  \node[s4] (dec)    at (0,-4.8)  {Newsvendor $q^\star$
...
\shorthandon{>}%
\caption{Arquitectura del sistema: flujo de datos y decisiones entre las cuatro capas funcionales (Datos, Features, Modelado y Decisión), con persistencia de cada ejecución en el almacén de MLflow para trazabilidad.}
