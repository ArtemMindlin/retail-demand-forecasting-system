...
\begin{itemize}
    ...
    \item \begin{sloppypar}\textbf{Diagnóstico Operacional por Excepción}: Cada recomendación atraviesa el clasificador de riesgo de \texttt{evaluation/}\allowbreak\texttt{reporting.py}, que le asigna la causa de mayor prioridad que le aplique (predicción sin modelo detrás, tramo con deriva detectada por Page-Hinkley, intervalo conformal anormalmente ancho o cantidad de pedido anormalmente alta) y vuelca las filas marcadas a \texttt{exceptions.csv}. La taxonomía completa y la razón de su orden de precedencia se detallan en la Sección~\ref{sec:excepciones}. El efecto práctico es que revisar el plan diario consiste en leer una lista corta con la causa ya nombrada, en lugar de inspeccionar los registros de ejecución para averiguar qué fue mal.\end{sloppypar}
\end{itemize}
