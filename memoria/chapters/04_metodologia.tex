...
El tercer guardarraíl existe porque los dos primeros no bastan. El umbral de mejora de coste es configurable y su valor por defecto es cero, de modo que por sí solo admite cualquier mejora por pequeña que sea: la comparación entre los dos \textit{backends} de este trabajo se decidía por una diferencia de coste de cinco centésimas de punto porcentual ($0{,}05\%$), magnitud que está dentro del propio ruido del experimento. Exigir evidencia estadística traslada a esta decisión el mismo criterio que el resto del trabajo aplica a cualquier comparación entre alternativas.
