...
\begin{tikzpicture}[x=0.155cm, y=0.062cm]
  ...
  \fill[gray!35, opacity=0.33] (-8.3,-22) rectangle (8.3,46);
  \draw[gray!70, dashed] (-8.3,-22) -- (-8.3,46);
  \draw[gray!70, dashed] (8.3,-22) -- (8.3,46);
  % Ejes
  ...
  \node[right,font=\sffamily\scriptsize] at (0.8,6.5) {$2\% \rightarrow 4\%$};
  \node[left=2pt,font=\sffamily\scriptsize] at (-10.6,20) {$10\% \rightarrow 20\%$};
  \node[right=1pt,font=\sffamily\scriptsize] at (-19,43) {$20\% \rightarrow 40\%$};
  ...
  \node[font=\sffamily\scriptsize,gray!85] at (-1.5,-19) {banda de ruido};
\end{tikzpicture}
\shorthandon{>}%
...
de coste sacrificado exige dos de Winkler. La banda gris es el semiancho del ruido del \textit{bootstrap}
($\pm 8{,}3$ pp), dentro del cual el experimento no distingue dos modelos por coste. El corte de la
frontera con la mayor brecha de Winkler observada entre \textit{backends} (línea naranja, $14{,}8$ pp)
cae \emph{dentro} de esa banda: con este $\lambda$, la calibración solo puede decidir donde el coste ya
no informa, nunca revertir una diferencia de coste real.}
