...
La Tabla~\ref{tab:forecasting_tuning_results} resume los resultados cuantitativos obtenidos para los dos \textit{backends} de \textit{Gradient Boosting} sobre el panel de 500 series.
...
\begin{itemize}
    \item \textbf{Degradación out-of-sample en LightGBM}: Durante la fase de selección, LightGBM alcanza un coste inferior al de CatBoost ($22{,}39$ frente a $23{,}97$). Sin embargo, en la ventana de validación posterior, el coste de LightGBM aumenta a $33{,}66$, evidenciando una alta sensibilidad y un sobreajuste a la ventana temporal de selección.
    \item \textbf{Estabilidad estructural de CatBoost}: CatBoost muestra un comportamiento marcadamente más estable entre ventanas ($23{,}97$ en selección frente a $28{,}89$ en validación). En la evaluación \textit{out-of-sample}, \textbf{CatBoost resulta un $14{,}2\%$ más económico que LightGBM} ($28{,}89$ vs. $33{,}66$ u.m.).
\end{itemize}
