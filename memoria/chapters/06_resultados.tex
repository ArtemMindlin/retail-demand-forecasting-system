...
\begin{table}[htbp]
    ...
    \begin{tabular}{lcccccc}
        ...
        \midrule
        LightGBM & 60 & 22{,}39 & 33{,}66 & 44{,}00 & -23{,}52\% & $[-11{,}45\%,\; -9{,}24\%]$ \\
        CatBoost & 60 & 23{,}97 & \textbf{28{,}89} & 33{,}26 & -13{,}15\% & $[-5{,}07\%,\; -3{,}68\%]$ \\
        \bottomrule
    \end{tabular}
    \caption{Resultados de la sintonización de hiperparámetros del modelo de forecasting (régimen \texttt{v3}) evaluados a través de la capa de calibración conformal de 14 días. El coste de validación refleja el rendimiento \textit{out-of-sample}.}
...
\begin{itemize}
    \item \textbf{Degradación out-of-sample en LightGBM}: Durante la fase de selección, LightGBM alcanza un coste inferior al de CatBoost ($22{,}39$ frente a $23{,}97$, Panel izquierdo de la Figura~\ref{fig:tuning_convergence_60trials}). Sin embargo, en la ventana de validación posterior, el coste de LightGBM aumenta a $33{,}66$, evidenciando una alta sensibilidad y un sobreajuste a la ventana temporal de selección.
    \item \textbf{Estabilidad estructural de CatBoost}: CatBoost muestra un comportamiento marcadamente más estable entre ventanas ($23{,}97$ en selección frente a $28{,}89$ en validación). En la evaluación \textit{out-of-sample}, \textbf{CatBoost resulta un $14{,}2\%$ más económico que LightGBM} ($28{,}89$ vs. $33{,}66$ u.m., Panel derecho de la Figura~\ref{fig:tuning_convergence_60trials}).
\end{itemize}
