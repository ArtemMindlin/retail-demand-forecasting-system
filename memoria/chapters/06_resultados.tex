...
\begin{itemize}
    ...
    \item \textbf{Término de seguridad compartido, estimable y proporcional a la serie}: la escala $\sigma$ del \textit{safety stock} se calcula sobre el panel \textbf{censurado} y \textbf{antes} de cualquier imputación, de modo que es idéntica para las cuatro estrategias y la diferencia de coste no mezcla la señal con la política. Que se estime sobre el panel censurado, y no sobre la demanda real de los días evaluados, la mantiene además dentro de lo observable en el momento de pedir: una versión anterior usaba la demanda verdadera, lo que introducía una cantidad de tipo oráculo en la política aunque fuese común a todas.

    Se calcula \textbf{una escala por serie} y no un único escalar para el catálogo. La diferencia no es un refinamiento: decide el resultado. Con un escalar común, el colchón $z_{q^*}\cdot\sigma$ valía unas 5{,}9 unidades frente a series que venden entre 4{,}95 y 18{,}27 unidades diarias --- el 120\% de la venta de la más pequeña y el 33\% de la de la más grande --- y a ese tamaño sepultaba las diferencias de una o dos unidades que separan a las señales entre sí. Las cuatro estrategias emitían pedidos casi idénticos y la comparativa medía el colchón en lugar de la reconstrucción.
